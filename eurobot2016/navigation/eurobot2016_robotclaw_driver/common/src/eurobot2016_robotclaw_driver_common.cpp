...
class eurobot2016_robotclaw_driver_config
{
public:
};

class eurobot2016_robotclaw_driver_data
{
...
class eurobot2016_robotclaw_driver_impl
{
...
public:
    eurobot2016_robotclaw_driver_impl() 
    {
    ...
    void configure(eurobot2016_robotclaw_driver_config config) 
    {
        /* protected region user configure on begin */
        /* protected region user configure end */
    }

    void update(eurobot2016_robotclaw_driver_data &data, eurobot2016_robotclaw_driver_config config)
    {
