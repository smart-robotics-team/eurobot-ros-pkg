                               ...
                               signed long speedM2)
{
    ...
    packet[0] = addr;
    packet[1] = 37;
    packet[2] = ((speedM1 >> 24) & 0xFF);
    packet[3] = ((speedM1 >> 16) & 0xFF);
    packet[4] = ((speedM1 >> 8) & 0xFF);
    packet[5] = (speedM1 & 0xFF);
    packet[6] = ((speedM2 >> 24) & 0xFF);
    packet[7] = ((speedM2 >> 16) & 0xFF);
    packet[8] = ((speedM2 >> 8) & 0xFF);
    packet[9] = (speedM2 & 0xFF);

    unsigned int crc = crc16(packet, 10);
