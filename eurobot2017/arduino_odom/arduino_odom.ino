...
void messageCbchargePin_ros(const std_msgs::Bool & msg)
{
  if(msg.data == true)
  {
...
ros::Subscriber < std_msgs::Bool > charge_ros("charge_pin", &messageCbchargePin_ros);
...
/*        write_RoboClaw_speed_M1M2(128,
  ...
  */  
    /*write_RoboClaw_speed_M1(128,
                                  100);
    */
    /*
    write_RoboClaw_speed_M2(128,
                                  delta_motor.des_speed +
                                  alpha_motor.des_speed);
    */
